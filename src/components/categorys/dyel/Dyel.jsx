...
import product1 from "@/assets/categorys/dyel/product1.jpg";
import product2 from "@/assets/categorys/dyel/product2.jpg";
import product3 from "@/assets/categorys/dyel/product3.jpg";
import product4 from "@/assets/categorys/dyel/product4.jpg";
import product5 from "@/assets/categorys/dyel/product5.jpg";
import product6 from "@/assets/categorys/dyel/product6.jpg";
import { useLocation } from "react-router-dom";

import video2 from "@/assets/categorys/dyel/video2.mp4";
import DyelBanner from "@/components/categorys/dyel/DyelBanner";
  ...
  const portfolios = [
    {
      id: 1,
      src: product1,
      category: "Contenido Dyel generado por @gelambienestar025",
  ...
  return (
    <div className="max-w-screen-xl mx-auto h-fit">
      ...
      <div className="my-10 mx-8 text-center lg:text-center lg:border-black">
        <h1 className="text-4xl lg:text-5xl text-[#c36501] text-center md:mb-20 mb-10">
          Dyel
        </h1>
        ...
        <p className="my-6 text-center border-l-4 pl-4 border-[#c36501] lg:text-center lg:border-black">
        ...
        <div className="w-full bg-gradient-to-b from-gray-800 to-black text-white mt-12">
          <div className="mx-auto flex h-full w-full max-w-screen-lg flex-col justify-center p-4 ">
            ...
            >
              <AiOutlineArrowUp className="text-[#c36501] " size={40} />
            </button>
          </div>
        </div>
      </div>
